 ...
 const FilteredHostels=meals.filter(
  (meal)=>meal.name.toLowerCase().includes(searchQuery.toLowerCase())
    ...
    return(<>
        ...
        <span class="location-icon"><FaLocationDot /></span>
        <input type="text" class="search-box" placeholder="Search Best Homemade food and snacks in your area"  onChange={(e) => setSearchQuery(e.target.value)}/>
